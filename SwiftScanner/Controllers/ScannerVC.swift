...
public class ScannerVC: UIViewController {
    ...
    public var successBlock: ((String) -> Void)?

    public var errorBlock: ((Error) -> Void)?
...
extension ScannerVC {
    ...
    public func setupScanner(_ title: String? = nil, _ color: UIColor? = nil, _ style: ScanAnimationStyle? = nil, _ tips: String? = nil, _ success: @escaping ((String) -> Void)) {
        if title != nil {
            self.title = title
        }
