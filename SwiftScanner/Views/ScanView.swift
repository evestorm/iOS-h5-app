...
extension ScanView {
    func setupTips() {
        ...
        NSLayoutConstraint.activate([tipsLbl.centerXAnchor.constraint(equalTo: centerXAnchor), tipsLbl.topAnchor.constraint(equalTo: contentView.bottomAnchor, constant: 20), tipsLbl.widthAnchor.constraint(equalToConstant: screenWidth), tipsLbl.heightAnchor.constraint(equalToConstant: 14)])
    }
